...
// for -> 구구단 3~ 5단 출력
// 3 x 1 = 3 ,...... 5 x 9 = 45
// for 종류 : 인덱스초기화:비교:증감, 데이터 덩어리(연속데이터,배열)에서 하나씩 꺼내는(for~each)
...
// 위의 방식은 진정한 for ~ each가 아니다. 데이터가 순순하게 나와야 한다 -> for ~ of 둥장
...
// ------------------------------------------------
// 만약, 추출한 데이터가 2거나 4가 나오면 출력하지 않고 다시 조건문으로 이동한다 
// for(조건문:통칭)
for( item of data ){
  if( item == 2 || item == 4 ){
